  ...
  return (
    <section className="relative min-h-[auto] md:min-h-[90vh] flex items-center pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden bg-gradient-to-b from-[#F7FAFC] to-white">
      ...
      <motion.div
        ...
        className="absolute top-[25%] left-[10%] hidden lg:flex items-center gap-2 px-3.5 py-2 bg-white/70 backdrop-blur-md rounded-full border border-white shadow-sm text-sm font-medium z-10"
      >
      ...
      <motion.div
        ...
        className="absolute top-[35%] right-[5%] hidden xl:flex items-center gap-2 px-3.5 py-2 bg-white/70 backdrop-blur-md rounded-full border border-white shadow-sm text-sm font-medium z-10"
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
        ...
        >
          <span className="inline-block py-1.5 px-3.5 rounded-full bg-white border border-[#D9E7EF] text-sm font-bold mb-6 md:mb-8 shadow-sm text-[#063B63]">
            The Digital Connect
          </span>
        ...
        >
          <div className="relative w-full max-w-[450px] aspect-[4/4.5] md:aspect-[4/5] rounded-3xl bg-[#0F172A] border border-[#1E293B] shadow-[0_20px_50px_-15px_rgba(15,23,42,0.6)] overflow-hidden group">
            ...
            <div className="absolute top-0 left-0 right-0 px-4 sm:px-6 py-5 flex justify-between items-center z-10 border-b border-white/5">
              <div className="flex gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-[#ef4444]"></div>
                <div className="w-2.5 h-2.5 rounded-full bg-[#eab308]"></div>
                <div className="w-2.5 h-2.5 rounded-full bg-[#22c55e]"></div>
              </div>
              <div className="flex items-center gap-2 px-3.5 py-1 bg-[#1e293b]/80 backdrop-blur-md rounded-full border border-white/10 text-[10px] font-mono text-[#38bdf8] uppercase tracking-wider">
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <div className="text-3xl font-extrabold text-white flex items-baseline gap-2">
                    +148% <span className="text-[#34d399] text-sm bg-[#34d399]/10 px-4 sm:px-6.5 py-0.5 rounded flex items-center">↑ 2.4%</span>
                  </div>
                </div>

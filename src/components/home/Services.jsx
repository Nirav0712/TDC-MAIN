      ...
      <div className="max-w-7xl mx-auto px-1 lg:px-1 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {servicesData.map((service, i) => {
            ...
            return (
              <Link to={service.link} key={i} className={`group p-6 lg:p-8 rounded-[24px] lg:rounded-3xl transition-all duration-500 hover:-translate-y-2 hover:shadow-xl relative overflow-hidden bg-white border border-[#D9E7EF]`}>

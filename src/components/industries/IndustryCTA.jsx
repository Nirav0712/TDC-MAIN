...
export const IndustryCTA = ({ title, variant }) => (
  <section className='py-20 lg:py-32 px-1 lg:px-1 relative overflow-hidden bg-[#061A2E] text-white'>
    ...
    <div className='max-w-[1000px] mx-auto text-center relative z-10'>
      ...
      <Link to='/contact' className='bg-[#18C5E8] text-[#03111F] px-3 py-5 rounded-xl font-extrabold text-[16px] tracking-wide hover:bg-white transition-all shadow-lg hover:-translate-y-1 inline-flex items-center gap-3 w-full sm:w-auto justify-center'>

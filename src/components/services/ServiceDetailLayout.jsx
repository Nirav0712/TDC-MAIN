        ...
        <div className={`min-h-screen bg-[#F7F5F2]`}>
            ...
            <section className={`relative pt-32 pb-24 overflow-hidden ${bg} border-b border-border/30 rounded-b-[40px] md:rounded-b-[60px]`}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <span className={`inline-block py-1.5 px-3.5 rounded-full bg-white/60 backdrop-blur-md border border-white shadow-sm text-sm font-bold mb-6 ${text}`}>
                            {subtitle}
                        </span>
                ...
                <div className="mb-24">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
                        {technologies.map((tech, i) => (
                            <div key={i} className="px-3.5 py-3 bg-white border border-border rounded-full font-semibold text-sm shadow-sm hover:-translate-y-1 transition-all duration-300">
                                {tech}
                            </div>
                        ))}
                    </div>
            ...
            <section className={`py-24 ${bg} border-y border-border/30`}>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <Button to="/contact" variant="primary" className="text-base px-6 py-3.5">

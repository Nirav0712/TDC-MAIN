    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                ...
                {/* 1. HERO SECTION */}
                <section className="relative pt-[120px] pb-20 lg:pt-[160px] lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="flex flex-col z-10">
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            <Link to="/contact" className="bg-[#171717] text-white px-6 py-3.5 rounded-full font-semibold text-sm hover:bg-black transition-all shadow-lg shadow-black/10 flex items-center gap-2">
                                Start a Project <ArrowRight className="w-4 h-4" />
                            </Link>
                            <Link to="/portfolio" className="bg-white border border-black/10 text-[#171717] px-6 py-3.5 rounded-full font-semibold text-sm hover:border-black/30 transition-all flex items-center gap-2">
                                Explore Our Work
                            </Link>
                        </div>
                    </div>
                ...
                <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#FAF9F7]">
                ...
                {/* 5. TECHNOLOGIES */}
                <section className="py-24 bg-white px-4 sm:px-6 lg:px-8 border-y border-black/5 overflow-hidden">
                    <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="w-full md:w-2/3 flex flex-wrap gap-3">
                            {technologies.map((tech, i) => (
                                <span key={i} className={`px-3.5 py-2.5 rounded-full border border-black/10 text-sm font-medium ${themeConfig.accentText} bg-white shadow-sm`}>
                                    {tech}
                                </span>
                            ))}
                        </div>
                ...
                <section className={`py-32 px-3.5 ${themeConfig.bg} overflow-hidden`}>
                    <div className="max-w-[1400px] mx-auto">
                        <UniqueVisual />
                    </div>
                </section>
                        ...
                        <div className="flex flex-col gap-4">
                            {faqs.map((faq, i) => (
                                <details key={i} className="group border border-black/10 rounded-2xl bg-[#FAF9F7] overflow-hidden">
                                    ...
                                    <div className="px-4 sm:px-6 pb-6 text-[#171717]/60 leading-relaxed text-sm">
                                        {faq.a}
                                    </div>
                                </details>
                            ))}
                ...
                {/* 11. FINAL CTA */}
                <section className={`py-32 px-4 sm:px-6 ${themeConfig.bg}`}>

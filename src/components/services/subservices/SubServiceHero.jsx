...
export const SubServiceHero = ({ parentTitle, parentRoute, title, eyebrow, description, theme, visual: Visual }) => (
    <section className="relative pt-[120px] pb-20 lg:pt-[160px] lg:pb-32 px-1 max-w-[1400px] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">
        <div className="flex flex-col z-10">
            ...
            <div className="flex flex-wrap flex-col sm:flex-row items-start sm:items-center gap-4">
                <Link to="/contact" className="bg-[#171717] text-white px-2 py-4 rounded-full font-semibold text-sm hover:bg-black transition-all shadow-lg flex items-center justify-center gap-2 w-full sm:w-auto">

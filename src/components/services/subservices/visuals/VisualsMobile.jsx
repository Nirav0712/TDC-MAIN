    ...
    <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center p-4 lg:p-8">
        <motion.div initial={{ y: 15 }} animate={{ y: [0, -10, 0] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }} className="w-[85%] max-w-[280px] h-[520px] bg-slate-900 rounded-[40px] shadow-2xl p-2 relative z-20 border-[4px] border-slate-800">
            ...
            <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative flex flex-col">
                <div className="h-6 w-full flex justify-between items-center px-4 sm:px-6 pt-2 text-[#0A1024]">
        ...
        {/* Floating Badges */}
        <motion.div animate={{ y: [0, -5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} className="absolute bottom-10 -left-4 lg:-left-12 bg-white px-4 sm:px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
        ...
        <motion.div animate={{ y: [0, 5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 0.5 }} className="absolute top-20 -right-4 lg:-right-8 bg-white px-4 sm:px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
    ...
    <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center p-4 lg:p-8">
        <motion.div initial={{ y: 20 }} animate={{ y: [0, -10, 0] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }} className="w-[85%] max-w-[280px] h-[520px] bg-slate-800 rounded-[24px] shadow-2xl relative z-20 border-[3px] border-slate-700 flex items-center justify-center overflow-hidden">
            <div className="w-[98%] h-[99%] bg-white rounded-[20px] overflow-hidden relative flex flex-col">
                <div className="h-6 w-full flex justify-between items-center px-4 sm:px-6 text-[#0A1024] border-b border-slate-100 pt-1">
        ...
        <motion.div animate={{ y: [0, -5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} className="absolute bottom-20 -left-2 lg:-left-6 bg-white px-4 sm:px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
...
export const FlutterVisual = () => (
    <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center p-4 lg:p-8">
        ...
        <motion.div animate={{ y: [0, -5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} className="absolute bottom-10 -left-6 bg-white px-4 sm:px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
        ...
        <motion.div animate={{ y: [0, 5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 0.5 }} className="absolute top-20 -right-6 bg-white px-4 sm:px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
...
export const ReactNativeVisual = () => (
    <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center p-4 lg:p-8">
        ...
        <motion.div animate={{ y: [0, -5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} className="absolute bottom-24 -left-6 bg-white px-4 sm:px-6 py-3 rounded-xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
        ...
        <motion.div animate={{ y: [0, 5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 0.5 }} className="absolute top-16 -right-4 bg-white px-4 sm:px-6 py-3 rounded-xl shadow-xl flex items-center gap-3 border border-slate-100 z-30">
...
export const CrossPlatformVisual = () => (
    <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center p-4">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="absolute top-12 left-4 w-64 h-40 bg-white rounded-lg shadow-2xl border-4 border-slate-800 z-10 flex flex-col overflow-hidden">
            <div className="h-4 bg-slate-100 w-full flex items-center px-4 sm:px-6 gap-1 border-b border-slate-200">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="absolute bottom-8 left-1/2 -translate-x-1/2 w-28 h-56 bg-white rounded-2xl shadow-2xl border-[3px] border-slate-800 z-30 flex flex-col overflow-hidden">
            ...
            <div className="px-4 sm:px-6 flex-1 flex flex-col gap-2">
        ...
        <motion.div animate={{ y: [0, -5, 0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} className="absolute bottom-4 right-2 bg-white px-4 sm:px-6 py-3 rounded-xl shadow-xl flex items-center gap-3 border border-slate-100 z-40">

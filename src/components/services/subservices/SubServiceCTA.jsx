    ...
    <section className={"py-32 px-1 " + theme.softBg}>
        <div className="max-w-[1000px] mx-auto text-center flex flex-col items-center">
            ...
            <div className="flex gap-4">
                ...
                <Link to="/services" className="bg-white border border-black/10 text-[#171717] px-3 py-5 rounded-full font-bold text-sm hover:border-black/30 transition-all flex items-center gap-3">

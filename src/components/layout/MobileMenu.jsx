        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        {/* Header */}
                        <div className="flex justify-between items-center px-4 sm:px-6 h-[72px] lg:h-[76px] shrink-0 border-b border-[#061A2E]/10 bg-[rgba(247,250,252,0.94)] backdrop-blur-md">
                        ...
                        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-8 pb-[calc(2rem+env(safe-area-inset-bottom))]">

    ...
    return (
        <div className="flex w-full h-full min-h-[440px]">
            ...
            <div className="w-[340px] shrink-0 bg-white border-r border-brand-border p-6 flex flex-col gap-2 relative">
                <h4 className="text-xs font-bold tracking-widest uppercase text-brand-text-muted mb-3 px-4 sm:px-6">Careers</h4>
                {data.items.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            className={`group relative flex flex-col px-4 sm:px-6 py-3 rounded-xl transition-all duration-200 ${isActive ? 'bg-brand-cyan/10' : 'hover:bg-brand-bg-light'}`}
                        >
                    ...
                    <div className="flex flex-col flex-1 pr-6 xl:pr-10 justify-center">
                        ...
                        <div className="flex items-center gap-6 mt-2">
                            <Link
                                ...
                                onClick={() => setActiveMenu(null)}
                                className="inline-flex items-center gap-2 bg-brand-primary-navy text-white px-3.5 py-3.5 rounded-full font-bold text-sm hover:bg-brand-deep-blue transition-all duration-300 shadow-md shadow-brand-primary-navy/10 group"
                            >

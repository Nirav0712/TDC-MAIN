    ...
    return (
        <div className="flex w-full h-[520px]">
            ...
            <div className="w-[340px] shrink-0 bg-brand-primary-navy p-6 flex flex-col gap-1 shadow-lg relative z-20">
                <h4 className="text-[11px] font-bold tracking-widest uppercase text-white/50 mb-4 px-4 sm:px-6">Hire Dedicated Experts</h4>
                    ...
                    return (
                        ...
                        >
                            <Link
                                ...
                                className={`flex items-center gap-3 px-4 sm:px-6 py-3 rounded-xl transition-all duration-300 ${isActive ? 'bg-brand-cyan text-brand-primary-navy shadow-md' : 'text-white hover:bg-white/10'}`}
                            >
                ...
                <div className="mt-auto px-4 sm:px-6 py-4 bg-white/5 rounded-xl border border-white/10">
                    ...
                    >
                        <div className="flex items-center justify-between border-b border-brand-border pb-6 mb-6">
                            ...
                            <Link
                                to={currentItem.href}
                                onClick={() => setActiveMenu(null)}
                                className="px-3.5 py-2.5 bg-brand-bg-light border border-brand-border rounded-full text-sm font-bold text-brand-primary-navy hover:bg-brand-primary-navy hover:text-white hover:border-brand-primary-navy transition-all"
                            >

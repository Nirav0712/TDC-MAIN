      ...
      <section className="py-24 bg-white relative border-y border-brand-border">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="overflow-x-auto pb-8 hide-scrollbar">
            <div className="flex items-center justify-between min-w-[800px] relative px-4 sm:px-6">
              {/* Line connecting */}
              ...
              {['Strategy', 'Design', 'Development', 'QA', 'Launch', 'Growth'].map((item, idx) => (
                <motion.div
                  ...
                  className="relative z-10 flex flex-col items-center gap-4 bg-white px-4 sm:px-6"
                >

...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-[72px] bg-brand-lavender/30 relative overflow-x-hidden w-full max-w-[100vw]">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative z-10 w-full max-w-7xl mx-auto flex-grow flex items-center">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white border-y border-brand-border relative z-10 w-full">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[#061B2E] relative overflow-hidden text-white mt-auto">

        ...
        <PageTransition>
            <div className="w-full bg-[#FAFAFA] min-h-screen font-sans">
                ...
                <div className="w-full h-[350px] bg-white rounded-3xl p-6 shadow-xl border border-gray-200 flex flex-col gap-4 overflow-hidden relative">
                    <div className="w-full h-1/3 bg-[#FAFAFA] rounded-2xl border-2 border-dashed border-[#08BFE8]/30 flex items-center px-1 relative overflow-hidden">
                    ...
                    <div className="w-full h-1/3 bg-[#FAFAFA] rounded-2xl border-2 border-dashed border-gray-200 flex items-center px-1 relative overflow-hidden scale-95 opacity-60">
                        <div className="absolute left-0 top-0 w-2 h-full bg-gray-300"></div>
                        <div className="font-bold text-gray-400">Tenant B (Starter)</div>
                    </div>
                    <div className="w-full h-1/3 bg-[#FAFAFA] rounded-2xl border-2 border-dashed border-gray-200 flex items-center px-1 relative overflow-hidden scale-90 opacity-40">
                        <div className="absolute left-0 top-0 w-2 h-full bg-gray-300"></div>

        ...
        <PageTransition>
            ...
            <div className="w-full bg-[#FAFAFA] min-h-screen font-sans">
                ...
                <div className="pt-[90px] md:pt-[100px] px-4 sm:px-6 max-w-[1320px] mx-auto text-sm font-medium text-[#7F94A8] flex flex-wrap items-center gap-2">
                    ...
                    <span className="text-[#061B2E] font-bold min-w-0 truncate">Hire Designers</span>
                </div>
                ...
                <section className="py-10 md:py-16 px-4 sm:px-6 lg:px-8 max-w-[1320px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col gap-6 z-10 w-full min-w-0">
                        ...
                        <motion.p initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{delay: 0.2}} className="text-[#7F94A8] text-lg leading-relaxed max-w-xl">
                            Elevate your digital products with world-class design. Hire UI/UX and product designers who merge aesthetics with intuitive user experiences.
                        </motion.p>
                ...
                <section className="py-16 bg-white border-y border-gray-100">
                    <div className="max-w-[1320px] mx-auto px-4 sm:px-6">
                        <div className="text-center max-w-2xl mx-auto mb-12">
                            <h2 className="text-[clamp(28px,4vw,40px)] font-heading font-black text-[#061B2E] mb-4">Our Designers Expertise</h2>
                            <p className="text-[#7F94A8] text-lg">Select a specialization below to learn more about our dedicated resources.</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            
                            <Link to="/hire-team/designers/ui-ux-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">UI/UX Designer</h3>
                            ...
                            <Link to="/hire-team/designers/graphic-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Graphic Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

                            <Link to="/hire-team/designers/product-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Product Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

                            <Link to="/hire-team/designers/web-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Web Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

                            <Link to="/hire-team/designers/mobile-app-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Mobile App Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

                            <Link to="/hire-team/designers/brand-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Brand Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

                            <Link to="/hire-team/designers/motion-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Motion Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

                            <Link to="/hire-team/designers/game-designer" className="bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl hover:border-[#08BFE8] hover:shadow-lg hover:shadow-[#08BFE8]/10 transition-all group flex flex-col min-w-0">
                                <h3 className="font-bold text-[#061B2E] text-lg mb-2 group-hover:text-[#08BFE8] transition-colors">Game Designer</h3>
                                <div className="mt-auto pt-4 flex items-center text-sm font-bold text-[#08BFE8]">
                                    Learn More <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform" />
                                </div>
                            </Link>

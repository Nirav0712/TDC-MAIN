    ...
    return (
        ...
        <div className="w-full aspect-square md:aspect-video lg:aspect-square bg-[#03111F] rounded-3xl p-6 relative overflow-hidden flex items-center justify-center border border-[#08BFE8]/20 shadow-2xl">
            ...
            <div className="flex flex-wrap gap-4 justify-center z-10 w-[80%]">
               <motion.div animate={{y:[0,-10,0]}} transition={{duration:3, repeat:Infinity, delay:0}} className="px-4 sm:px-6 py-2 bg-white/5 border border-[#D9A72E]/30 rounded-lg text-white font-mono text-sm shadow-[0_0_15px_rgba(217,167,46,0.2)]">async</motion.div>
               <motion.div animate={{y:[0,-10,0]}} transition={{duration:3, repeat:Infinity, delay:1}} className="px-4 sm:px-6 py-2 bg-[#D9A72E] text-black font-bold border border-[#D9A72E]/30 rounded-lg font-mono text-sm">await</motion.div>
               <motion.div animate={{y:[0,-10,0]}} transition={{duration:3, repeat:Infinity, delay:2}} className="px-4 sm:px-6 py-2 bg-white/5 border border-[#D9A72E]/30 rounded-lg text-white font-mono text-sm shadow-[0_0_15px_rgba(217,167,46,0.2)]">Promise</motion.div>
            </div>
        </div>
                    </div>
                </section>

...
const Portfolio = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-20">
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-brand-soft relative overflow-hidden text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            {filters.map((f) => (
              <button
                ...
                className={`px-3.5 py-2.5 rounded-full text-sm font-bold transition-all ${activeFilter === f ? 'bg-primary text-white shadow-md' : 'bg-brand-soft text-muted-foreground hover:bg-border'}`}
              >
                {f}
              </button>
            ))}

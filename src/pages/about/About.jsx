        ...
        <PageTransition>
            <div className="w-full bg-[#F7FAFC] min-h-screen font-sans flex flex-col">
                ...
                <section className="relative pt-[120px] pb-[80px] lg:pt-[160px] lg:pb-[120px] overflow-hidden bg-[#061B2E] text-white">
                    ...
                    <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
                        <motion.span
                ...
                <section className="relative -mt-12 z-20 pb-16 lg:pb-24 px-4 sm:px-6 lg:px-8 max-w-[1320px] mx-auto w-full">
                ...
                <section className="relative w-full bg-[#061B2E] text-white py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">

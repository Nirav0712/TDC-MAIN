    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FFFFFF] min-h-screen font-sans flex flex-col">
                ...
                <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-[#061B2E] text-center w-full">
                ...
                <section className="py-24 max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 w-full">

    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FFFFFF] min-h-screen font-sans flex flex-col">
                ...
                <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-[1320px] mx-auto text-center w-full">
                ...
                <section className="py-32 bg-[#061B2E] text-center px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                    <h2 className="text-4xl md:text-6xl font-black text-white mb-8">Build Something Meaningful</h2>
                    <button className="bg-[#19C7E8] text-[#061B2E] px-6 py-3.5 rounded-full font-bold hover:bg-white transition-colors">Start A Project</button>
                </section>
            </div>
        </PageTransition>
    );

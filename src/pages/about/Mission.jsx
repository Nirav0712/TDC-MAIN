    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FFFFFF] min-h-screen font-sans flex flex-col">
                ...
                <section className="pt-24 pb-16 px-1 md:px-1 max-w-[1320px] mx-auto text-center w-full">
                ...
                <section className="py-32 bg-[#061B2E] text-center px-1 flex flex-col items-center">
                    <h2 className="text-4xl md:text-6xl font-black text-white mb-8">Build Something Meaningful</h2>
                    <button className="bg-[#19C7E8] text-[#061B2E] px-2 py-4 rounded-full font-bold hover:bg-white transition-colors">Start A Project</button>
                </section>
            </div>
        </PageTransition>
    );

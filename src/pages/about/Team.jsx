    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAFAFA] min-h-screen font-sans">
                {/* HERO */}
                <section className="bg-[#08243A] pt-[120px] pb-[80px] lg:pt-[160px] lg:pb-[120px] px-4 sm:px-6 lg:px-8 relative overflow-hidden text-center z-10 border-b border-[#08BFE8]/10">
                        ...
                        <div className="flex overflow-x-auto no-scrollbar gap-6 md:gap-10 py-4">
                            {teamData.map((team, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span className={`text-xs font-bold px-4 sm:px-6 py-1 rounded-md ${isActive ? 'bg-[#08BFE8] text-white' : 'bg-gray-100 text-gray-500'}`}>{team.number}</span>
                ...
                <section className="relative z-20 py-16 lg:py-24 px-4 sm:px-6 lg:px-8 max-w-[1320px] mx-auto w-full">
                ...
                <div className="max-w-[1320px] mx-auto px-4 sm:px-6 pb-24 lg:pb-32">
                    ...
                    <section id="engineering" className="py-16 md:py-24 lg:py-32 scroll-mt-[120px] border-t border-gray-200">
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <div className="bg-[#08243A] rounded-[40px] p-6 md:p-8 lg:p-10 relative overflow-hidden text-sm md:text-base font-mono text-[#08BFE8] shadow-2xl h-[350px] md:h-[400px] flex flex-col justify-center">
                                ...
                                <div className="relative z-10 space-y-3 px-4 sm:px-6 lg:px-8">
                    ...
                    <section id="growth" className="py-16 md:py-24 lg:py-32 scroll-mt-[120px] border-t border-gray-200">
                        <div className="bg-[#061B2E] rounded-[40px] px-4 sm:px-6 py-12 md:px-4 sm:px-6 md:py-16 lg:p-20 relative overflow-hidden shadow-2xl">

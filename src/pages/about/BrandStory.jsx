    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FFFFFF] min-h-screen font-sans flex flex-col">
                ...
                <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-[1320px] mx-auto text-center w-full border-b border-[#F4FAFC]">
                ...
                <section className="py-24 max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 w-full relative">

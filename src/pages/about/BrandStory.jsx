    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FFFFFF] min-h-screen font-sans flex flex-col">
                ...
                <section className="pt-24 pb-16 px-1 md:px-1 max-w-[1320px] mx-auto text-center w-full border-b border-[#F4FAFC]">
                ...
                <section className="py-24 max-w-[800px] mx-auto px-1 w-full relative">
